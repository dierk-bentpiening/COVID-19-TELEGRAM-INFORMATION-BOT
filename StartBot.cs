    ...
    static async void Bot_OnMessage(object sender, MessageEventArgs e)
    {
        ...
        try
        {
            ...
            if (e.Message.Text != null || cmdlist[0] != null)
            {
                ...
                else if (e.Message.Text == "Infektionen Weltweit" || e.Message.Text == "infektionen weltweit" || e.Message.Text == "Infektionen weltweit" || e.Message.Text == "iw" || e.Message.Text == "IW" || e.Message.Text == "Iich gw")
                {
